...
.l-section.height_custom {
	padding-top: <?php echo us_get_option( 'row_height_custom' ) ?>;
	padding-bottom: <?php echo us_get_option( 'row_height_custom' ) ?>;
	}
<?php } ?>
...
<?php if ( $with_shop ) { ?>
.no-touch .widget_layered_nav_filters li a:hover,
<?php } ?>
