...
global $usof_img_sizes, $usof_body_fontsize, $usof_enable_portfolio, $usof_portfolio_label, $usof_sidebar_titlebar, $help_portal_url;
...
$pages_layout_predefined_types = array(
	...
	'portfolio' => __( 'Portfolio', 'us' ) . $renamed_portfolio_label,
);
