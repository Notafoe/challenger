...
if ( us_get_option( 'paste_from_demo', 1 ) AND (
		defined( 'US_DEV' )
		OR get_option( 'us_license_activated', 0 )
...
function us_vc_add_paste_section_html() {
	...
	<div class="us-paste-section-window" style="display: none;" <?php echo us_pass_data_to_js( $data ) ?>
		 data-nonce="<?php echo wp_create_nonce( 'us_ajax_import_shortcode_data' ) ?>">
		<div class="vc_ui-panel-window-inner">
			...
			<div class="vc_ui-panel-content-container">
				<div class="vc_ui-panel-content vc_properties-list vc_edit_form_elements wpb_edit_form_elements">
					<div class="vc_column">
						<div
							class="wpb_element_label"><?php echo sprintf( __( 'Copy needed section on any %sdemo site%s and paste it here:', 'us' ), '<a href="http://' . strtolower( US_THEMENAME ) . '.us-themes.com/" target="_blank">', '</a>' ); ?></div>
