...
class Promo_Box extends Base {
	...
	protected function render() {
		...
		// promo link
		$this->add_render_attribute( 'promo_link', 'href', esc_url( $settings['promo_link']['url'] ) );
		if ( ! empty( $settings['promo_link']['is_external'] ) ) {
			$this->add_render_attribute( 'promo_link', 'target', '_blank' );
		}
		if ( ! empty( $settings['promo_link']['nofollow'] ) ) {
			$this->set_render_attribute( 'promo_link', 'rel', 'nofollow' );
		}
		...
		if ( ! empty( $settings['button_link']['nofollow'] ) ) {
			$this->set_render_attribute( 'button_link', 'rel', 'nofollow' );
		}
		?>
						...
						<?php if ( !empty( $settings['title'] ) ) : ?>
							<<?php echo tag_escape( $settings['title_tag'] ); ?> class="ha-promo-box-title">
								...
								<?php if ( !empty( $settings['promo_link']['url'] ) ) : ?>
									<a <?php echo $this->get_render_attribute_string( 'promo_link' ); ?>>
