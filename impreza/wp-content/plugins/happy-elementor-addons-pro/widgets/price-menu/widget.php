			...
			<?php foreach ( $settings['price_list'] as $key => $item ) : ?>
				<div <?php $this->print_render_attribute_string( 'item' ); ?>>
					...
					<div class="ha-price-menu-content">
						<div class="ha-price-menu-header">
							<h4 class="ha-price-menu-title">
								...
								if ( ! empty( $item['link']['url'] ) ) {
									$this->set_render_attribute( $repeater_key, 'href', $item['link']['url'] );
							...
							<?php if ( 'beside_title' === $settings['price_position'] && $item['price'] ) : ?>
								<div class="ha-price-menu-price-wrap">
									<?php if ( $item['old_price'] ) : ?>
										<span
											class="ha-price-menu-old-price"><?php echo esc_html( $item['old_price'] ); ?></span>
									<?php endif; ?>
						...
						<?php if ( $item['desc'] ) : ?>
							<div class="ha-price-menu-desc"><p><?php echo esc_html( $item['desc'] ); ?></p></div>
						<?php endif; ?>
