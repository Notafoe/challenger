...
class Advanced_Heading extends Base {
    ...
    protected function render() {
        ...
        $heading_before = ha_kses_basic( $settings[ 'heading_before' ] );
        $heading_center = ha_kses_basic( $settings[ 'heading_center' ] );
        $heading_after = ha_kses_basic( $settings[ 'heading_after' ] );
        ...
        if ( ! empty( $settings['link']['url'] ) ) {
			...
			<<?php echo tag_escape( $settings['title_tag'] ); ?> class="ha-advanced-heading-tag">
				<a <?php echo $this->get_render_attribute_string( 'link' ) ?>>
					<div class="ha-advanced-heading-wrap" data-background-text="<?php echo esc_attr( $settings['background_text']); ?>">
							<span class="ha-advanced-heading-before"><?php echo $heading_before; ?></span>
							<span class="ha-advanced-heading-center"><?php echo $heading_center; ?></span>
							<span class="ha-advanced-heading-after"><?php echo $heading_after; ?></span>
