...
class Timeline extends Base {
	...
	protected function register_style_controls() {
		...
		//Timeline Content Style Section Start
		$this->start_controls_section(
		...
		//Timeline Icon Style Section Start
		$this->start_controls_section(
		...
		//Timeline Title Style Section Start
		$this->start_controls_section(
		...
		//Timeline Time & Date Style Section Start
		$this->start_controls_section(
		...
		//Timeline Button Style Section Start
		$this->start_controls_section(
	...
	<div <?php echo $this->get_render_attribute_string('timeline-wrap'); ?>>
		<?php if ($settings['timeline_item']):
			foreach ($settings['timeline_item'] as $key => $item):?>
				...
				?>
				<div <?php echo $this->get_render_attribute_string('timeline-block'); ?>>
					...
					<div <?php echo $this->get_render_attribute_string('content-box'); ?>">
					<?php if (($date || $time) && ($settings['show_date'] || $settings['show_time'])): ?>
