    ...
    protected function render() {
        ...
        <ul class="ha-list-wrap">
            <?php foreach ( $settings['list_item'] as $index => $item ) :
                ...
                if ( $item['link']['url'] ) {
                    $this->add_render_attribute( $repeater_key, 'class', 'ha-link' );
                    ...
                    <?php endif; ?>
                        ...
                        <div class="ha-item-wrap">
                            ...
                            <div class="ha-text">
                                    ...
                                    <h4 <?php echo $this->get_render_attribute_string( $title_key ); ?>>
                                        <?php echo $item['title']; ?>
                                    </h4>

                                <?php if ( $item['description'] ) : ?>
                                    <p <?php echo $this->get_render_attribute_string( $description_key ); ?>>
