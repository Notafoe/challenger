<?php
	...
	class WooLentorPro {
        ...
        function admin_notice_license_plugin() {
            $title = esc_html__( 'Welcome to WooLentor Pro!', 'woolentor' );
            $message = esc_html__( 'Please activate your license to get automatic updates and premium support.', 'woolentor' );
        ...
        function ActiveAdminMenu(){
            add_submenu_page(
                'woolentor_page', 
                esc_html__( 'Licence', 'woolentor-pro' ),
                esc_html__( 'Licence', 'woolentor-pro' ), 
                'manage_options', 
                $this->slug, 
