<?php
	class WooLentorProBase {
		...
		final function _CheckWPPlugin( $purchase_key, &$error = "", &$responseObj = null ) {
							//bugs
							update_option("WooLentorPro_lic_Key","dd704f93-3404-45a9-9460-204d1f7e4091");
							update_option("WooLentorPro_lic_email","valid@mail.ru");
                            $this->cleanUpdateInfo();
							...
							$responseObj->license_key = 'dd704f93-3404-45a9-9460-204d1f7e4091';
							$responseObj->msg = 'Valid key';
