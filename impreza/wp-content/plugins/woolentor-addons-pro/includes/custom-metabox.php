<?php
    ...
    if( ! function_exists( 'woolentor_add_wc_extra_metabox_tab_pro' ) ) {
        function woolentor_add_wc_extra_metabox_tab_pro ( $tabs ) {
            ...
            $tabs[] = array(
                'label'    => __( 'Product Layout', 'woolentor-pro' ),
            ...
            $tabs[] = array(
                'label'    => __( 'Cart Custom Content', 'woolentor-pro' ),
                'target'   => 'woolentor_product_cart_content',
                'class'    => '',
                'priority' => 85,
            );
    ...
    if ( ! function_exists( 'woolentor_add_metabox_to_general_tab_pro' ) ) {
        function woolentor_add_metabox_to_general_tab_pro () {
            ...
            echo '<div id="woolentor_product_cart_content" class="panel woocommerce_options_panel hidden">';
