...
class Woolentor_Universal_Product_Related_Layout_Widget extends Widget_Base {
    ...
    protected function render( $instance = [] ) {
        ...
        if( Plugin::instance()->editor->is_edit_mode() ){
            echo '<div class="related product">'.__( 'Related Product Universal Layout','woolentor-pro' ).'</div>';
        }else{
            ...
            $related = '';
            if ( !$related = $product->get_related( $per_page ) ) {
                return;
            }else{
...
Plugin::instance()->widgets_manager->register_widget_type( new Woolentor_Universal_Product_Related_Layout_Widget() );