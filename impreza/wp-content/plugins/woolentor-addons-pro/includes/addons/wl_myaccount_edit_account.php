...
class WL_Myaccount_Edit_Accoount_ELement extends Widget_Base {

    public function get_name() {
        return 'wl-account-edit';
    }

    public function get_title() {
        return __( 'WL: My Account Edit', 'woolentor-pro' );
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new WL_Myaccount_Edit_Accoount_ELement() );