    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                'orderby',
                [
                    'label' => __( 'Orderby', 'woolentor-pro' ),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'none',
                    'options' => [
            ...
            $this->add_control(
                ...
                [
                    'label' => __( 'Child Category Product', 'woolentor-pro' ),
                    'type' => Controls_Manager::SWITCHER,
                    'return_value' => 'yes',
                    'default' => 'no',
                    'description'=> __( 'If there is no product in child category, display from parent category.','woolentor-pro' ),
                ]
            );
                ...
                $this->start_controls_tab(
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-woolentor-custom-product-archive nav.woocommerce-pagination ul' => 'border-color: {{VALUE}}',
                                '{{WRAPPER}}.elementor-widget-woolentor-custom-product-archive nav.woocommerce-pagination ul li' => 'border-right-color: {{VALUE}}; border-left-color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'type' => Controls_Manager::COLOR,
                            'selectors' => [
                                '{{WRAPPER}}.elementor-widget-woolentor-custom-product-archive nav.woocommerce-pagination ul li a' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}}.elementor-widget-woolentor-custom-product-archive nav.woocommerce-pagination ul li span.current' => 'color: {{VALUE}}',
                            ],
                        ]
                    );
                    ...
                    $this->add_control(
                        ...
                        [
                            ...
                            'selectors' => [
                                ...
                                '{{WRAPPER}}.elementor-widget-woolentor-custom-product-archive nav.woocommerce-pagination ul li span.current' => 'background-color: {{VALUE}}',
                            ],
                        ]
                    );
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' =>'#aaaaaa',
                    'selectors' => [
                        '{{WRAPPER}} .woocommerce .wlshop-list-price-ratting .star-rating::before' => 'color: {{VALUE}};',
                    ],
                ]
            );
            ...
            $this->add_control(
                ...
                [
                    ...
                    'default' =>'#dc9a0e',
                    'selectors' => [
                        '{{WRAPPER}} .woocommerce .wlshop-list-price-ratting .star-rating span::before' => 'color: {{VALUE}};',
                    ],
                ]
            );
    ...
    protected function render( $instance = [] ) {
            ...
            echo '<div class="woocommerce ht-row"><div class="ht-col-xs-12">';
                ?>
                    <ul class="wl-shop-tab-links">
                        <li><a href="#grid" class="<?php if( $settings['woolentor_product_view_mode'] == 'grid' ){ echo 'htactive'; } ?>"><i class="sli sli-grid"></i></a></li>
                        <li><a href="#list" class="<?php if( $settings['woolentor_product_view_mode'] == 'list' ){ echo 'htactive'; } ?>"><i class="sli sli-menu"></i></a></li>
                    </ul>
                <?php
        ...
        ?>
            <div class="ht-products woocommerce" >
                ...
                <div class="wl-shop-tab-pane <?php if( $settings['woolentor_product_view_mode'] == 'grid' ){ echo 'htactive'; } ?>" id="grid">
                    <div class="ht-row">
                        <?php
                ...
                <div class="wl-shop-tab-pane <?php if( $settings['woolentor_product_view_mode'] == 'list' ){ echo 'htactive'; } ?>" id="list">
                    <div class="ht-row">
