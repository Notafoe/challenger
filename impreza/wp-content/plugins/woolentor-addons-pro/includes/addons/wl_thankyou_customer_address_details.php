...
class WL_Thankyou_Customer_Address_Details_ELement extends Widget_Base {
...
Plugin::instance()->widgets_manager->register_widget_type( new WL_Thankyou_Customer_Address_Details_ELement() );