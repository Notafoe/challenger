...
class Woolentor_Universal_Product_Upsell_Layout_Widget extends Widget_Base {
    ...
    protected function render( $instance = [] ) {
        ...
        if( Plugin::instance()->editor->is_edit_mode() ){
            echo '<div class="upsell product">'.__( 'Upsell Product Universal Layout','woolentor-pro' ).'</div>';
        }else{
...
Plugin::instance()->widgets_manager->register_widget_type( new Woolentor_Universal_Product_Upsell_Layout_Widget() );