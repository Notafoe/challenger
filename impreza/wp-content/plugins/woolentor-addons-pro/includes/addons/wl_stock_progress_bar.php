...
class WL_Product_Stock_Progressbar_Element extends Widget_Base {
    ...
    protected function render() {
        ...
        if ( Plugin::instance()->editor->is_edit_mode() ) {
            echo '<div class="stock-management-progressbar">'.__('Stock Management Progress Bar','woolentor-pro').'</div>';
        }else{
...
Plugin::instance()->widgets_manager->register_widget_type( new WL_Product_Stock_Progressbar_Element() );