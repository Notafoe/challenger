...
class WL_Myaccount_Account_ELement extends Widget_Base {
        ...
        $this->start_controls_section(
            ...
            $repeater->add_control(
                ...
                [
                    ...
                    'type' => Controls_Manager::TEXT,
                    'default' => esc_html__( 'newmenuitem' , 'woolentor-pro' ),
                    'label_block' => true,
                    'condition'=>[
    ...
    public function my_account_content( $settings, $userinfo, $menutype ){
        ...
        new \WooLentor_MyAccount( $items, $item_url, $userinfo );
...
Plugin::instance()->widgets_manager->register_widget_type( new WL_Myaccount_Account_ELement() );