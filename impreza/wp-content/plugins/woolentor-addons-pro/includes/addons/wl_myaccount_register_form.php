...
class WL_Myaccount_Register_Form_ELement extends Widget_Base {
    ...
    public function get_title() {
        return __( 'WL: Myaccount Register Form', 'woolentor-pro' );
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new WL_Myaccount_Register_Form_ELement() );