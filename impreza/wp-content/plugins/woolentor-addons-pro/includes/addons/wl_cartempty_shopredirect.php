...
class WL_Product_Empty_Cart_Redirect_Button_ELement extends Widget_Base {
    ...
    public function get_title() {
        return __( 'WL: Empty Cart Redirect Button', 'woolentor-pro' );
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new WL_Product_Empty_Cart_Redirect_Button_ELement() );