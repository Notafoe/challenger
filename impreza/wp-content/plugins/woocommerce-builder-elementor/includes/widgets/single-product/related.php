...
class DTWCBE_Single_Product_Related_Widget extends DTWCBE_Product_Base {
	...
	public function get_title() {
		return esc_html__( 'Woo Product Related', 'woocommerce-builder-elementor' );
	}
	...
	protected function _register_controls() {
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Related products', 'woocommerce' ),
		...
		$this->add_control(
			'posts_per_page',
			[
				'label' => esc_html__( 'Products Per Page', 'woocommerce-builder-elementor' ),
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					...
					'title' => esc_html__( 'Date', 'woocommerce' ),
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type(new DTWCBE_Single_Product_Related_Widget());