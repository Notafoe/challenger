...
class DTWCBE_Single_Archive_Description_Widget extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'section_style',
			array(
				'label' => esc_html__( 'Archive description', 'woocommerce' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'options'      => [
					'left'   => [
						'description' => esc_html__( 'Left', 'elementor' ),
						'icon'  => 'fa fa-align-left',
					],
					'center' => [
						'description' => esc_html__( 'Center', 'elementor' ),
						'icon'  => 'fa fa-align-center',
					],
					'right'  => [
						'description' => esc_html__( 'Right', 'elementor' ),
